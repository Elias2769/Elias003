...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Elias Hossen
\033[1;37m Facebook:            Elias Hossen
\033[1;37m Github  :            Elias2769
...
def cutter():
    ...
    ssb = input('Put File Name:')
    print(" ")
    elias = input('Saving Put File Name:')
    os.system('touch ' +elias)
    os.system('sort -r '+ssb+' | uniq > '+elias)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
